...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	...
	<tbody>
		...
		<tr class="gradeA">
			...
			<td class="center">
<?php
			if($row['occupancy_status'] < $row['capacity'])
			{
?>
			<a href="updated_rooms_allot.php?room_no=<?php echo $row['room_no']?>&submit=View"><button>Add</button></a>
<?php
			}
?>
			</td>
...
<?php
	...
	{
?>
			<a href="updated_rooms_allot.php?room_no=<?php echo $row["room_no"]?>&submit=View"><button>Delete</button></a>
<?php
	}
?>
		</tr>
