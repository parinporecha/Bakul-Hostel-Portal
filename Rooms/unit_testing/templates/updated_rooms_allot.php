...
?>
			...
			<input type="checkbox" name="student1" value=<?php echo $row["student1"]?>>Student 1<br/>
...
?>
			...
			<br/><h4>Delete Students</h4>
			<input type="checkbox" name="student1" value=<?php echo $row["student1"]?>>Student 1<br/>
			<input type="checkbox" name="student2" value=<?php echo $row["student2"]?>>Student 2<br/>
...
?>
			...
			<input type="checkbox" name="student1" value=<?php echo $row["student1"]?>>Student 1<br/>
			<input type="checkbox" name="student2" value=<?php echo $row["student2"]?>>Student 2<br/>
			<input type="checkbox" name="student3" value=<?php echo $row["student3"]?>>Student 3<br/>
