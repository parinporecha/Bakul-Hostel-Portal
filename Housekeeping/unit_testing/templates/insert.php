...
<input id="Field7" name="bdate" type="text" class="field text fn" value="" tabindex="3" />
...
<span class="left state">
<input id="Field7" name="responsibility" type="text" class="field text ln" value="" tabindex="5" />
<label for="Field7">responsibility</label>
</span>

<!--<label for="Field7" class="right state">Job</label>
--><span class="right job">
<select id="Field9" name="job" value="" class="field select addr" tabindex="11">
...
<span>
<input id="Field35" name="contact_no" type="tel" class="field text" value="" size="10" maxlength="10" tabindex="10" />
</span>
...
<li class="buttons ">
<div>
	<input id="saveForm" name="saveForm" class="btTxt submit" type="submit" value="Insert" />
</div>
</li>
