...
<form id="form16" name="form16" class="wufoo  page"  enctype="multipart/form-data" method="post" novalidate
action="update.php">
<header id="header" class="info">
<h2>Hoskeeping Staff's Profile</h2>
<div></div>
</header>
...
<span>
<input id="Field1" name="id" type="text" class="field text fn" value="<?php echo $row['id'] ?>" size="8" tabindex="1" />
...
<span >
<input id="Field1" name="name" type="text" class="field text fn" value="<?php echo $row['name'] ?>" size="8" tabindex="1" />
...
<input id="Field7" name="bdate" type="text" class="field text fn" value="<?php echo $row['bdate'] ?>" tabindex="3" />
<label for="Field7">Birth Date</label>
</span>

<span class="right state">
<input id="Field8" name="sex" type="text" class="field text fn" value="<?php  echo $row['sex'] ?>" maxlength="1" tabindex="4" />
...
<span class="left state">
<input id="Field7" name="responsibility" type="text" class="field text ln" value="<?php  echo $row['responsibility'] ?>" tabindex="5" />
<label for="Field7">responsibility</label>
</span>

<!--<label for="Field7" class="right state">Job</label>
--><span class="right job">
<select id="Field9" name="job" value="<?php  echo $row['job'] ?>" class="field select addr" tabindex="11">
<option value="" selected="selected"></option>
<option value="Plumber" >Plumber</option>
<option value="Electrician" >Electrician</option>
<option value="Carpenter" >Carpenter</option>
</select>
<label for="Field9">Job</label>
</span>
...
<input id="Field4" name="address" type="text" class="field text addr" value="<?php  echo $row['address'] ?>" tabindex="7" />
</span>
...
<span>
<input id="Field35" name="contact_no" type="tel" class="field text" value="<?php  echo $row['contact_no'] ?>" size="10" maxlength="10" tabindex="10" />
</span>
