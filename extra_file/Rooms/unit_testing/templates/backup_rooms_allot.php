...
<?php
$value =
$result = mysql_query("select room_no from student_room where student1=$value or student2=$value or student3=$value;");
	...
	<body id="dt_example">
		<div id="container">
			...
			<form name="room_enter" action="updated_rooms_allot.php" onsubmit="return Validate_Room()" method="get">
				...
				<input type="submit" name="submit" value="View"><a href="../index.php" style="float:right"><button>View all rooms</button></a><br/>
			</form>
<?php
            if($row)
	    {
