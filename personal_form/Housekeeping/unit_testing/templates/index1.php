...
$iidd=$_GET["roll_no"];
                $con=mysql_connect();
                        ...
                        $result = mysql_query("select * from students where id='".$iidd."'");
...
<input id="Field7" name="guardian_name" type="text" class="field text fn" value="" tabindex="2" />
...
<input id="Field7" name="roll_no" type="text" class="field text fn" value="" tabindex="3" />
...
<span class="left state">
<input id="Field7" name="allergy" type="text" class="field text ln" value="" tabindex="5" />
<label for="Field7">Allergy</label>
</span>

<span class="right state">
<input id="Field7" name="bloodgroup" type="text" class="field text ln" maxlength="30" value="" tabindex="6" />
