...
$i=0;
$complete_user=$user_name;
while($complete_user[$i]!='@')
	$i++;
$student_user=substr($complete_user,0,$i);
...
fwrite($file_pointer, date('M d, H:i:s')." MODIFY: $user modified personal form of student $student_user.\n");
fclose($filename);
