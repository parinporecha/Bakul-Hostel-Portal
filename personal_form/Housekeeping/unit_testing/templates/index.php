...
$iidd=$_GET["roll_no"];
                $con=mysql_connect();
                        ...
                        $result = mysql_query("select * from students where roll_no='".$iidd."'");
...
<span>
<input id="Field35" name="guardian_contact_no" type="tel" class="field text" value="<?echo $row['guradian_contact_no']?>" size="10" maxlength="10" tabindex="10" />
</span>
